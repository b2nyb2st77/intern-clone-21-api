  ...
  checkTimeError: (startTime, endTime, res) => {
    switch (checkTime(startTime, endTime)) {
      case error.OVER_TIME_ERROR:
        responseHandler.responseValidateError(res, error.PRECONDITION_FAILED, error.OVER_TIME_ERROR_MESSAGE)
        return false
      case error.PAST_TIME_ERROR:
        responseHandler.responseValidateError(res, error.PRECONDITION_FAILED, error.PAST_TIME_ERROR_MESSAGE)
        return false
      case error.TIME_DIFFERENCE_ERROR:
        responseHandler.responseValidateError(res, error.PRECONDITION_FAILED, error.TIME_DIFFERENCE_ERROR_MESSAGE)
        return false
      case error.DATE_DIFFERENCE_ERROR:
        responseHandler.responseValidateError(res, error.PRECONDITION_FAILED, error.DATE_DIFFERENCE_ERROR_MESSAGE)
        return false
      default:
        return true
    }
